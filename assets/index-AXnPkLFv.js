...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function rl(){return new $n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ya(),fragmentShader:`
		...
		`,blending:Yn,depthTest:!1,depthWrite:!1})}function ol(){return new $n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ya(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Og(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Ol?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===$h?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Bn&&(e="SHADOWMAP_TYPE_VSM"),e}function kg(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ci:case ts:e="ENVMAP_TYPE_CUBE";break;case Ur:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Gg(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case ts:e="ENVMAP_MODE_REFRACTION";break}return e}function Hg(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case kl:e="ENVMAP_BLENDING_MULTIPLY";break;case gu:e="ENVMAP_BLENDING_MIX";break;case _u:e="ENVMAP_BLENDING_ADD";break}return e}function zg(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Vg(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const c=Og(t),l=kg(t),h=Gg(t),u=Hg(t),d=zg(t),A=Rg(t),m=Dg(r),g=i.createProgram();let p,f,y=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(ys).join(`
`)),o=Ia(o),o=gl(o,t),o=_l(o,t),a=Ia(a),a=gl(a,t),a=_l(a,t),o=El(o),a=El(a),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
